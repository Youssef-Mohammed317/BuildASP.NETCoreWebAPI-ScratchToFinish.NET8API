        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserVaildEmailCheck", "Email Like '_%@_%._%'");
                    table.CheckConstraint("GymUserVaildPhoneCheck", "Phone Like '01%' and Phone Not Like '%[^0-9]%");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlanDurationInDaysCheck", "DurationInDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserVaildPhoneCheck1", "Phone Like '01%' and Phone Not Like '%[^0-9]%");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberShips", x => new { x.MemberId, x.PlanId, x.StartDate });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberSessions", x => new { x.BookingDate, x.MemberId, x.SessionId });
                    table.ForeignKey(
